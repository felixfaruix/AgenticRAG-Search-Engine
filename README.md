...
The entire idea starts from one simple assumption: not every question is the same, so they need different retrieval strategies. Every choice is grounded on the most recent research papers on this topic. 
