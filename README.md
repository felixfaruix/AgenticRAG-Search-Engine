...
Dear reader/s, this project reflects my approach and consequent thinking processes I like to apply to my projects. Evaluation driven, everything quantifiable - if I can't quantify the results, I haven't built anything. A demo is a demo, but building reliable AI systems requires much more effort and A LOT of end-to-end testings. Isolation is unfortunately not easy when it comes to AI application. Thus, we need to have a good baseline evaluation we can refer to. 
